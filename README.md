...
Run `mvn spring-boot:run` for a dev server. Navigate to `http://localhost:2001/`. The application will automatically reload if you change any of the source files.
